...
const emails = [
    ...
    {date: Date.now(), id: 0, from: 'baba@example.com', to: 'tuki@example.com', isRead: false, subject: 'hello b!', text: emailText, flag: '', category: {sent:false,inbox:true}},
    {date: Date.now(), id: 1, from: 'caba@example.com', to: 'tuki@example.com', isRead: false, subject: 'hello c!', text: emailText, flag: '', category: {sent:false,inbox:true}},
    {date: Date.now(), id: 2, from: 'daba@example.com', to: 'tuki@example.com', isRead: false, subject: 'hello d!', text: emailText, flag: '', category: {sent:false,inbox:true}},
    {date: Date.now(), id: 3, from: 'eaba@example.com', to: 'tuki@example.com', isRead: false, subject: 'hello e!', text: emailText, flag: '', category: {sent:false,inbox:true}},
